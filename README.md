...
<p align="center">
  <b>AI-powered fashion discovery using deep learning & visual similarity</b>
</p>

<p align="center">
  🚀 <a href="https://fashioniq.streamlit.app" target="_blank"><b>Live Demo</b></a>
</p>

---

## 🌟 Project Overview
**FashionIQ** is an AI-driven fashion recommendation system that suggests visually similar fashion items using deep learning–based feature extraction.  
...
## ⚙️ How It Works
1. Fashion images are processed using a pretrained **ResNet18 CNN**
2. Visual features are extracted from images
3. A **KNN model** finds visually similar items
4. Results are displayed via an interactive dashboard
